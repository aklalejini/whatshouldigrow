...
const cropRules = [
  ...
  rule(["napa cabbage", "michihili", "tokyo bekana", "chijimisai", "hon tsai tai", "shungiku"], {
    daysToMaturityMin: 35,
    daysToMaturityMax: 80,
    matureHeightFtMin: 0.75,
    matureHeightFtMax: 2,
  ...
  rule(["burdock", "lotus root", "taro", "eddoe"], {
    daysToMaturityMin: 120,
    daysToMaturityMax: 210,
    matureHeightFtMin: 2,
    matureHeightFtMax: 5,
    matureSpreadFtMin: 1.5,
    matureSpreadFtMax: 4,
    ...
    difficultyScore: 3,
    dataConfidence: "low",
    sourceKeys: ["ncsu-plant-toolbox", "mobot-plant-finder", "umaine-vegetable-yield"]
  }),
  rule(["luffa", "snake gourd", "bitter melon", "wax gourd"], {
    daysToMaturityMin: 70,
    ...
    difficultyScore: 3,
    dataConfidence: "low",
    sourceKeys: ["umn-vegetable-field-planning", "lsu-vegetable-yields", "ncsu-plant-toolbox"]
  }),
  rule(["winged bean", "hyacinth bean", "mung bean", "sword bean"], {
    daysToMaturityMin: 60,
    daysToMaturityMax: 100,
    matureHeightFtMin: 2,
    matureHeightFtMax: 10,
  ...
  rule(["chinese hawthorn", "hawthorn fruit tree", "yangmei chinese bayberry"], {
    firstYieldYearsMin: 3,
    firstYieldYearsMax: 6,
    fullYieldYearsMin: 6,
    fullYieldYearsMax: 10,
  ...
  rule(["korean pine nut", "pine nut", "ginkgo nut tree", "kerman pistachio", "pistachio"], {
    firstYieldYearsMin: 5,
    firstYieldYearsMax: 10,
    fullYieldYearsMin: 10,
    fullYieldYearsMax: 18,
    matureHeightFtMin: 30,
    matureHeightFtMax: 70,
    matureSpreadFtMin: 20,
    matureSpreadFtMax: 45,
    spacingPlantFtMin: 25,
    spacingPlantFtMax: 40,
    spacingRowFtMin: 25,
    spacingRowFtMax: 40,
