...
<!-- Affiliate placeholder: tree limb spreaders and clothespin-style branch weights for fruit training. -->
...
<!-- Affiliate placeholder: bypass pruning shears with replaceable blades. -->
...
<!-- Affiliate placeholder: floating row cover frost cloth, roughly 10 by 30 feet. -->
...
Pull the turf back at least to the drip line. Mulch with three inches of wood chips, kept off the trunk by a few inches. Stop fertilizing. If a soil test (and you should do one, they cost around twelve dollars and answer half the questions in this article) shows you're short on potassium or phosphorus, address those specifically. Nitrogen is almost never what a non-fruiting tree needs. A mail-in soil test kit from a state extension lab is the cheapest useful tool in this whole list.

<!-- Affiliate placeholder: mail-in soil test kit from a state extension lab. -->
...
A young fruit tree needs about 10 to 15 gallons a week during establishment, delivered slowly. A drip line, or a five-gallon bucket with a small hole in the bottom set next to the trunk, works better than a sprinkler. A simple drip irrigation kit with 1 gph emitters runs about forty dollars and outlasts most hoses. Once a tree is established (year four onward for most stone fruit, longer for apples and pears) it can usually find its own water except in true drought. But during the year you're trying to get a first crop, water it like you mean it.

<!-- Affiliate placeholder: drip irrigation kit with 1 gph emitters for trees and shrubs. -->
...
<!-- Affiliate placeholder: fruit tree pest and disease field guide for your part of the country. -->
